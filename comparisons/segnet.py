...
from keras.layers import Input, concatenate, Conv2D,Convolution2D, MaxPooling2D, UpSampling2D, Dropout, BatchNormalization
...
def get_segnet():
    ...
    autoencoder.compile(loss=dice_coef_loss, optimizer='adam',
...
def train():
    ...
    print('-' * 30)
    model = get_segnet()
    model_checkpoint = ModelCheckpoint('/home/NanLi/ceshi/unsmceshi/u_net/raw/file/segnet.hdf5', monitor='val_loss',
                                       save_best_only=True)
